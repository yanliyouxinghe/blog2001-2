...
@section('content')
  ...
  <a href="/">首页</a>
  <a href="/goodstype/list">商品类型管理</a>
  <a><cite>类型列表</cite></a>
</span>
    <!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
    <title>类型列表</title>
    <center><h1>类型列表</h1><a href="/goodstype/create"><button type="button" class="btn btn-primary">前往添加</button></a></center><hr/>
